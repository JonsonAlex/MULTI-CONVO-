users = {'GURU': 'GURU', 'GURU': 'GURU', 'GURU': 'GURU'}  
...
def venom():
    ...
    y = '''
\033[1;97m---------------------------------------------------------------------\n
\033[1;97m\033[1;93m* \033[1;97mN4M3    \033[1;91m: \033[1;96mL3G3ND GURU\033[1;97m--------••||\n
\033[1;97m\033[1;93m* \033[1;97mF4C3BOOK      \033[1;91m: \033[1;96mMOHAMMAD SAJID\033[1;97m-------••||\n
\033[1;97m--------------------------------------------------------------------------
...
if int:
    print('''\033[1;36m---------------------------------------------------------------------\n''')
    print('''\033[1;35m<=======>[ N99M HI K9FI HAI GURU BADSHAH :D ]=-''')
    print('''\033[1;33m<=>[ Author : TH3 L3G3ND B0Y GURU H3R3 /]=-\n''')
    print('''\033[1;36m---------------------------------------------------------------------\n''')
    i = datetime.now()
    print(i.strftime("\033[1;32m[#] Start Time ==> %Y-%m-%d %I:%M:%S %p "))
    print('''\033[1;32m[#]_==>[ TH3 L3G3ND GURU H3R3 ]\n''')
